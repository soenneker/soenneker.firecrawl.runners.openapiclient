...
using Soenneker.Firecrawl.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Firecrawl.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Firecrawl:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/firecrawl/firecrawl-docs/main/api-reference/v2-openapi.json";
        ...
        await _kiotaUtil.Generate(filePath, "FirecrawlOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
